...
const Flashspot = cimports.ui.flashspot;
...
Applet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {
        ...
        this._panelEditModeChangedId = global.cinnamon_settings.connect('changed::panel-edit-mode', Lang.bind(this, function() {
            this._setAppletReactivity();
        }));
    },
    ...
    _onAppletRemovedFromPanel: function() {
        global.cinnamon_settings.disconnect(this._panelEditModeChangedId);
