...
const BoxPointer = cimports.ui.boxpointer;
const DND = cimports.ui.dnd;
const Main = cimports.ui.main;
const Tweener = cimports.ui.tweener;
const CheckBox = cimports.ui.checkBox;
const RadioButton = cimports.ui.radioButton;
...
PopupMenu.prototype = {
    ...
    _init: function(sourceActor, orientation) {
        ...
        this.actor = new St.Bin({ style_class: 'menu', important: true });
        this.actor._delegate = this;
        this.actor.connect('key-press-event', Lang.bind(this, this._onKeyPressEvent));
    ...
    open: function(animate) {
        ...
        if (animate && global.cinnamon_settings.get_boolean("desktop-effects-on-menus")) {
            this.animating = true;
