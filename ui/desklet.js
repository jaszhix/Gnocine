...
Desklet.prototype = {
    ...
    _init: function(metadata, desklet_id){
        ...
        global.cinnamon_settings.connect('changed::desklet-decorations', Lang.bind(this, this._updateDecoration));
    ...
    _updateDecoration: function(){
        let dec = global.cinnamon_settings.get_int('desklet-decorations');
