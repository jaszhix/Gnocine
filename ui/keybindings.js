...
var Desktop, DesktopMK;
try {
    Desktop = imports.gi.GnomeDesktop;
    DesktopMK = imports.gi.GDesktopEnums.MediaKeyType;
} catch(e) {
    Desktop = imports.gi.CinnamonDesktop;
    DesktopMK = imports.gi.GDesktopEnums.MediaKeyType;
}
const CinnamonDesktop = Desktop;
const MK = DesktopMK;
