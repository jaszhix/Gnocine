...
function onEnabledExtensionsChanged() {
    enabledExtensions = global.cinnamon_settings.get_strv(ENABLED_EXTENSIONS_KEY);
...
function init() {
    ...
    global.cinnamon_settings.connect('changed::' + ENABLED_EXTENSIONS_KEY, onEnabledExtensionsChanged);
