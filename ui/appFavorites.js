...
AppFavorites.prototype = {
    ...
    _init: function() {
        this._favorites = {};
        global.cinnamon_settings.connect('changed::' + this.FAVORITE_APPS_KEY, Lang.bind(this, this._onFavsChanged));
        this._reload();
    },
    ...
    _reload: function() {
        let ids = global.cinnamon_settings.get_strv(this.FAVORITE_APPS_KEY);
    ...
    _addFavorite: function(appId, pos) {
        ...
        global.cinnamon_settings.set_strv(this.FAVORITE_APPS_KEY, ids);
