...
const Tooltips = cimports.ui.tooltips;
...
PanelAppLauncher.prototype = {
    ...
    _init: function(launchersBox, app, appinfo, orientation, panel_height, scale) {
        ...
        this._draggable.inhibit = !this.launchersBox.allowDragging || global.cinnamon_settings.get_boolean(PANEL_EDIT_MODE_KEY);
        this.launchersBox.connect("launcher-draggable-setting-changed", Lang.bind(this, this._updateInhibit));
        global.cinnamon_settings.connect('changed::' + PANEL_EDIT_MODE_KEY, Lang.bind(this, this._updateInhibit));
    },
...
MyApplet.prototype = {
    ...
    _init: function(metadata, orientation, panel_height, instance_id) {
        ...
        this.actor.reactive = global.cinnamon_settings.get_boolean(PANEL_EDIT_MODE_KEY);
        global.cinnamon_settings.connect('changed::' + PANEL_EDIT_MODE_KEY, Lang.bind(this, this._onPanelEditModeChanged));
    ...
    do_gsettings_import: function() {
        let old_launchers = global.cinnamon_settings.get_strv(PANEL_LAUNCHERS_KEY);
        if (old_launchers && old_launchers.length >= 1 && old_launchers[0] != "DEPRECATED") {
            this.launcherList = old_launchers;
        }

        global.cinnamon_settings.set_strv(PANEL_LAUNCHERS_KEY, ["DEPRECATED"]);
    },
