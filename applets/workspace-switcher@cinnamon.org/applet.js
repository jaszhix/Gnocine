...
WorkspaceGraph.prototype = {
    ...
    _init: function(index, applet) {
        ...
        this.graphArea = new St.DrawingArea({ style_class: 'windows' });
    ...
    update: function() {
        if (typeof this.graphArea === 'undefined') {
            return false;
        }
...
MyApplet.prototype = {
    ...
    _init: function(metadata, orientation, panel_height, instance_id) {
        ...
        try {
            ...
            global.cinnamon_settings.connect('changed::panel-edit-mode', Lang.bind(this, this.on_panel_edit_mode_changed));
    ...
    on_panel_edit_mode_changed: function() {
        let reactive = !global.cinnamon_settings.get_boolean('panel-edit-mode');
    ...
    _onFocusChanged: function() {
        ...
        this._focusWindow = global.patchMetaWindowActor(global.display.focus_window.get_compositor_private());
