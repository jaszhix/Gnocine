...
WindowPreview.prototype = {
    ...
    show: function() {
        ...
        this.muffinWindow = global.patchMetaWindowActor(this.metaWindow.get_compositor_private());
...
AppMenuButton.prototype = {
    _init: function(applet, metaWindow, alert) {
        ...
        global.cinnamon_settings.connect('changed::panel-edit-mode', Lang.bind(this, this.onPanelEditModeChanged));
    ...
    onPanelEditModeChanged: function() {
        if (this._draggable)
            this._draggable.inhibit = global.cinnamon_settings.get_boolean("panel-edit-mode");
    },
...
MyApplet.prototype = {
    ...
    _init: function(orientation, panel_height, instance_id) {
        ...
        global.cinnamon_settings.bind("panel-edit-mode", this.actor, "reactive", Gio.SettingsBindFlags.DEFAULT);
